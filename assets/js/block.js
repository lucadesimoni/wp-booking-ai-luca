				...
				[
					el(
						...
						el(
							PanelBody,
							{
								title: __('Calendar Settings', 'wp-booking-system'),
								initialOpen: true
							},
							el(TextControl, {
								label: __('Title', 'wp-booking-system'),
					...
					el(
						...
						el('h3', { style: { margin: '10px 0' } }, attributes.title || __('Booking Calendar', 'wp-booking-system')),
						el('p', { style: { color: '#666', fontStyle: 'italic', margin: 0 } }, 
							__('The booking calendar will appear here on the frontend.', 'wp-booking-system')
						)
					)
				]
			);
